...
export class Button extends Component<ButtonProps> {
  ...
  render(): JSX.Element {
    ...
    const buttonClass = classNames(
      "p-2 min- text-md rounded font-bold flex items-center justify-center gap-2",
      sizeClass,
      {
      ...
      {
        "transition-transform active:scale-95 hover:bg-greenMid": !disabled && variant === "solid",
        "transition-transform active:scale-95 hover:bg-greenLight hover:text-dark": !disabled && variant === "border",
